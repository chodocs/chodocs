...
<template>
  <section class="flex flex-col border-1 border-neutral-400 border-solid rounded-md p-4 gap-4 transition  dark:border-neutral-600
  ...
  ">
    ...
    <div class="flex item-center justify-between">
      <div class="flex items-center gap-1">
        ...
        <span class="text-ellipsis w-full whitespace-nowrap overflow-hidden text-sm opacity-75 font-500">{{ href }}</span>
      </div>
      <div class="flex items-center gap-1">
        <span class="text-ellipsis w-full whitespace-nowrap overflow-hidden text-sm font-500 opacity-50">chodocs.cn</span>
      </div>
    </div>
  </section>
</template>
